...
import { User, Clock, Refresh, CircleCheck, CircleClose, Loading, InfoFilled } from '@element-plus/icons-vue';
import type { Component } from 'vue';
import { getCallbackLogByOrderNumber, callbackLogRetry } from '@/service/api/inventory/return-supplier';

defineOptions({ name: 'ReturnSupplierCallBackRecord' });
...
function init(data: any) {
  if (data && data.orderNumber) {
    ...
    console.log('CallBackRecord组件初始化完成，缺少订单号');
  }
}
